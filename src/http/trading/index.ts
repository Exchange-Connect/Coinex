...
export function submitLimitOrder(
	...
	price?: string,
	{
		...
		client_id?: string;
		hide?: "true" | "false";
		option?: "NORMAL" | "IOC" | "FOK" | "MAKER_ONLY";
		access_id?: string;
		tonce: number;
	} = { tonce: Date.now() }
) {
 ...
 */
export function submitLimitOrdersInBatch(
	batch_orders: {
		type: "sell" | "buy";
		amount: string;
		price: string;
	...
	market: string,
	{ account_id, access_id, tonce }: { account_id?: number; access_id?: string; tonce: number } = { tonce: Date.now() }
) {
	// @ts-ignore
	const { apiKey, apiSecret } = this;
	const params = {
...
export function submitMarketOrder(
	...
	amount: string,
	{
		...
		access_id,
		tonce,
	}: { account_id?: number; client_id?: string; access_id?: string; tonce: number } = { tonce: Date.now() }
) {
	// @ts-ignore
	const { apiKey, apiSecret } = this;
	const params = {
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function submitIOCOrder(
	market: string,
	type: "sell" | "buy",
	amount: string,
	price: string,
	{
		...
		access_id,
		tonce,
	}: { source_id?: string; account_id?: number; client_id?: string; access_id?: string; tonce: number } = {
		tonce: Date.now(),
	}
) {
	// @ts-ignore
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function submitStopLimitOrder(
	market: string,
	type: "sell" | "buy",
	amount: string,
	price: string,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function submitStopMarketOrder(
	market: string,
	type: "sell" | "buy",
	amount: string,
	stop_price: string,
 ...
 */
// @ts-ignore
export function inquireOrderStatus(
	id: string,
	market: string,
	{
		access_id,
 ...
 */
// @ts-ignore
export function inquireOrderStatusInBatch(
	batch_ids: string,
	market: string,
	{
		access_id,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function inquireExecutedOrderDetail(
	id: string,
	{
		account_id,
		page,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function inquireStopOrderHistory(
	{
		market,
		account_id,
		page,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function inquireUnexecutedOrder(
	type: "sell" | "buy",
	{
		market,
		account_id,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function inquireOrderHistory(
	start_time: number,
	end_time: number,
	{
		market,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function inquireUnexecutedStopOrder(
	{
		market,
		account_id,
		type,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function inquireUserTransactionRecords(
	{
		market,
		account_id,
		type,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function cancelOrdersInBatch(
	batch_ids: string,
	market: string,
	{
		account_id,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function cancelUnexecutedStopOrder(
	market: string,
	{
		account_id,
		type,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function cancelAllUnexecutedStopOrders(
	market: string,
	{
		account_id,
		access_id,
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function acquireUserTradingFeeRate() {
	// @ts-ignore
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function acquireMarketTransactionInfo() {
	// @ts-ignore
	const { apiSecret } = this;
	const params = {};
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export function modifyANormalOrder(
	market: string,
	id: string,
	{
		amount,
