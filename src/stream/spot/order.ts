 ...
 */
export function orderSubscribe(markets: string[], onData: () => any) {
 ...
 * @memberof Streams.spot.order
 */
export function orderUnsubscribe() {
	const client = connections.spot;
	if (!client) throw new Error("Web Socket is not Connected!");
 ...
 */
export async function orderQuery(market: string, side: 0 | 1 | 2, offset: number, limit: number) {
	const client = connections.spot;
	if (!client) throw new Error("Web Socket is not Connected!");
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export async function orderQueryStop(market: string, side: 0 | 1 | 2, offset: number, limit: number) {
	const client = connections.spot;
	if (!client) throw new Error("Web Socket is not Connected!");
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export async function orderQueryAccount(account: number, market: string, side: 0 | 1 | 2, offset: number, limit: number) {
	const client = connections.spot;
	if (!client) throw new Error("Web Socket is not Connected!");
 ...
 * @returns {Promise<Object>} Promise object represents the result of the request
 */
export async function orderQueryAccountStop(
	account: number,
	market: string,
	side: 0 | 1 | 2,
	offset: number,
