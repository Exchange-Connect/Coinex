...
import {
	...
	UnavailableTransferToAccountDueToRejectionError,
	UnavailableMergeDepthError,
	ServiceUnavailableDuoFundingFeeSettlementError,
	ServiceIsBusyError,
	UnavailableBalanceDueToRepeatingUpdateError,
	PositionAmountExceedsLimitError,
	InsufficientCounterPartiesError,
	ExceedsLimitError,
	PositionLiquidationError
...
export const RESPONSE_CODES = {
	...
	49: {
		...
		error: UnavailableTransferToAccountDueToRejectionError,
	},
	107: {
	...
	651: {
		...
		error: UnavailableMergeDepthError
	},
	3007: {
		...
		error: ServiceUnavailableDuoFundingFeeSettlementError
	...
	3107: {
		...
		error: UnavailableBalanceDueToRepeatingUpdateError
	}, // UnavailableBalanceDueToRepeatingUpdateError
	3108: {
		message: "amount exceed limit",
		description: "The position amount exceeds the upper limit",
		error: PositionAmountExceedsLimitError
	},
	3109: {
	...
	3110: {
		...
		error: InsufficientCounterPartiesError
	},
	3111: {
		message: "exceed max limit",
		description: "limit value exceeds the maximum limit",
		error: ExceedsLimitError
	},//FIX: extends limitvalueexeeds
	3112: {
	...
	3115: {
		...
		error: PositionLiquidationError
	},
	3116: {
 ...
 * @enum {Object} RESPONSE_STATUS_CODES
 * @memberof HTTPConstants
 */
